    ...
    <div className="bg-white min-h-screen pb-24">
      ...
      <div className="relative w-full h-[60vh] min-h-[450px] max-h-[550px] bg-[#78350F] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="/indian_students_hero.png" alt="Hero Background" className="w-full h-full object-cover" />
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#FDE68A]/30 shadow-sm mb-16">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="flex-1 w-full">
                <img src="/indian_students_hero.png" alt="University Campus" className="w-full h-[400px] object-cover rounded-3xl shadow-xl" />
              </div>
            </div>
          </div>
        </FadeInUp>
