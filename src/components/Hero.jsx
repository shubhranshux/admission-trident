...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-screen min-h-[650px] max-h-[1080px] overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-[2] pointer-events-none overflow-hidden">
        {/* Slide 0: Subtle glowing indigo arcs */}
        <div className="absolute top-[-10%] right-[-5%] w-[60vw] h-[60vw] rounded-full border-[1px] border-[#312E81]/20"
          style={{ opacity: active === 0 ? 1 : 0, transform: active === 0 ? 'scale(1)' : 'scale(1.1)', transition: 'all 1.5s ease-out' }} />
        <div className="absolute top-[5%] right-[2%] w-[40vw] h-[40vw] rounded-full border-[2px] border-[#312E81]/10 bg-[#312E81]/5 blur-3xl"
          style={{ opacity: active === 0 ? 1 : 0, transition: 'all 1s' }} />

        {/* Slide 1: Soft teal geometric polygon */}
        <div className="absolute bottom-[-10%] right-[10%] w-[50vw] h-[50vw] rotate-45 bg-gradient-to-tr from-[#0F766E]/5 to-transparent blur-2xl"
          style={{ opacity: active === 1 ? 1 : 0, transform: active === 1 ? 'translateY(0)' : 'translateY(50px)', transition: 'all 1.5s ease-out' }} />
        
        {/* Slide 2: Orange floating elements */}
        <div className="absolute top-[20%] right-[15%] w-64 h-64 rounded-full bg-[#EA580C]/10 blur-[80px]"
          style={{ opacity: active === 2 ? 1 : 0, transform: active === 2 ? 'translateX(0)' : 'translateX(30px)', transition: 'all 1.5s ease-out' }} />
        <div className="absolute bottom-[20%] right-[5%] w-96 h-96 rounded-full bg-[#EA580C]/5 blur-[100px]"
          style={{ opacity: active === 2 ? 1 : 0, transition: 'all 1s' }} />

        {/* Slide 3: Amber diagonal streaks */}
        <div className="absolute top-0 right-0 w-[40vw] h-[150vh] bg-gradient-to-l from-[#D97706]/20 to-transparent blur-xl"
